...
<html>
<head>
    <title>Remove seller:Relief Estates</title>
...
<div class="sellerdetialsdiv">
        ...
        <table class="sellerdetailstable">
            <thead>
            <tr>
                <th colspan="2"><h1>seller Details</h1></th>
            </tr>
            <tr>
                <th>Username</th>
                <th>Delete seller</th>
            ...
            <tbody>
            <?php
            $query="SELECT ausername FROM sellers";
                ...
                else
                {
                    while ($row = mysql_fetch_assoc($query_run))
                    {
                        ...
                        ?>
                            <tr>
                                <td><?php echo $name; ?></td>
                                <td><a href="deleteseller.php?del=<?php echo $name; ?>"><input type="button" class="removebutton" value="Delete"></a></td>
                            </tr>
                        <?php
                    }
                }
